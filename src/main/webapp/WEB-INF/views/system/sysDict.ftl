...
<div class="easyui-layout" fit="true" border="false">
    <div data-options="region:'west',split:true" title="字典分组" style="width:40%;" collapsible="false">
        ...
        <div id="tb">
            <a onclick="newModel('${ctx!}/sysDict/newGroupModel', '500px', '300px')" href="#" class="easyui-linkbutton" iconCls="iconfont icon-add" plain="true">新增</a>
            <a onclick="editModel('dg','${ctx!}/sysDict/newGroupModel', '500px', '300px')" href="#" class="easyui-linkbutton" iconCls="iconfont icon-edit" plain="true">编辑</a>
            <a onclick="deleteModel('dg','${ctx!}/sysDict/deleteGroupAction')" href="#" class="easyui-linkbutton  " iconCls="iconfont icon-delete" plain="true">删除</a>
